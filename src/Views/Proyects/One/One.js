    ...
    <div className="one-container">
      <div className="cont-p">
        ...
        <div className="div-comp3">
          ...
          <h1>01</h1>
          <p>
            Inteligencia, <br /> automatizaciones <br /> & data para <br />{" "}
            contrataciones
          </p>
          <p>
            Reclutachat arranca con un concepto <br /> para generar base de
            datos de personal <br /> y búsqueda de talento masivo para <br />{" "}
            grandes empresas, análisis de rotación <br /> y predicciones
            psicométricas.
          </p>
        ...
        <div className="div-comp4">
          ...
          <ul>
            <li>
              <span>-</span>
              <p>Inteligencia para chatbots</p>
            </li>
            <li>
              <span>-</span>
              <p>Conversaciones automáticas</p>
            </li>
            <li>
              <span>-</span>
              <p>Generación de base de datos</p>
            </li>
            <li>
              <span>-</span>
              <p>Predicción de rotación</p>
            </li>
            <li>
              <span>-</span>
              <p>Predicción de accidents</p>
            </li>
            <li>
              <span>-</span>
              <p>Capacitaciones digitales, en VR, y gameficadas</p>
            </li>
            <li>
              <span>-</span>
              <p>Automatización en fechas para los reclutadores </p>
            </li>
            <li>
              <span>-</span>
              <p>Comunicación previa, durante y posterior a las campañas</p>
            </li>
