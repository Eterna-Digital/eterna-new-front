    ...
    <div className="three-container">
      <div className="t-cont">
        ...
        <div className="w-cont" ref={(el) => (text3 = el)}>
          ...
          <h1>03</h1>
          <p>
            Sistema aumentado <br />
            de comunicación
          </p>
          <p>
            La familia wunnel tiene diferentes <br /> automatizaciones con el
            objetivo de unificar <br /> la comunicación de una empresa, desde{" "}
            <br /> nuevas contrataciones, administración de <br /> viáticos,
            reembolsos a clientes, pagos <br /> simples, entre otras.
          </p>
          <div className="btn-card">
            <a
              href="https://www.wunnel.app/"
              target="_blank"
              rel="noreferrer"
              className="btn"
            >
